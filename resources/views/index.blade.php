	        ...
	        <div class="container">
	            ...
	            <div class="row">
	            	<div class="col-sm-5 more-features-box wow fadeInLeft">
	                    <img src="user_theme/assets/img/devices/iphone.png" alt="">
	                </div>
	        ...
	        <div class="container">
	            ...
	            <div class="row">
	                ...
	                <div class="col-sm-5 great-support-box wow fadeInUp">
	                    <img src="user_theme/assets/img/devices/pc.png" alt="">
	                </div>
	            </div>
	        </div>
        </div>
	            ...
	            <div class="row">
	                <div class="col-sm-4 about-us-box wow fadeInUp">
		                <div class="about-us-photo">
		                	<img src="user_theme/assets/img/about/1.jpg" alt="" data-at2x="user_theme/assets/img/about/1.jpg">
		                </div>
	                    <h3>Jim Black</h3>
	                ...
	                <div class="col-sm-4 about-us-box wow fadeInDown">
		                <div class="about-us-photo">
		                	<img src="user_theme/assets/img/about/2.jpg" alt="" data-at2x="user_theme/assets/img/about/2.jpg">
		                </div>
	                    <h3>Tom Brown</h3>
	                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
	                    <div class="about-us-social">
	                ...
	                <div class="col-sm-4 about-us-box wow fadeInUp">
		                <div class="about-us-photo">
		                	<img src="user_theme/assets/img/about/3.jpg" alt="" data-at2x="user_theme/assets/img/about/3.jpg">
		                </div>
	                    <h3>Sarah Green</h3>
	                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
	                    <div class="about-us-social">
